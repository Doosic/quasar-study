    ...
    <section class="q-mb-xl">
      ...
      <div class="bg-primary q-pa-xs">
        <div class="bg-dark text-white">
          ...
          debitis totam soluta temporibus ducimus voluptatibus impedit mollitia
          alias nobis beatae facere, possimus id deserunt ea nisi fugiat,
          inventore laborum molestias.
        </div>
      </div>
    ...
    <section class="q-mb-xl">
      ...
      >
        ...
        <q-card-actions>
          ...
          <q-btn padding="lg" outline>Action 2</q-btn>
        </q-card-actions>
      </q-card>
    </section>
  </q-page>
