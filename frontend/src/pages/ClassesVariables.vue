  ...
  <q-page class="q-pa-md q-pa-md-xl">
    ...
    <section class="q-mb-xl">
      ...
      <div class="ellipsis">
        ...
        odit quidem facilis tenetur ducimus voluptate architecto ullam sit,
        exercitationem maiores explicabo cupiditate. Ipsum, laudantium eum rem
        architecto asperiores libero!
      </div>
      <hr />
